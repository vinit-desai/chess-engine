...
public abstract class Player {
    ...
    public MoveTransition makeMove(final Move move){
        ...
        final Board transitionBoard=move.execute(); //Player gets switched
        final Collection<Move> kingAttacks=Player.calculateAttackOnTile(transitionBoard.currentPlayer().getOpponent().getPlayerKing().getPiecePosition(),
                transitionBoard.currentPlayer().getLegalMoves());   //Therefore we use currentPlayer().getOpponent() to see if the move leaves the prev player in check
